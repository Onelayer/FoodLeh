    ...
    <!-- Navigation-->
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lg-1" >
                            <div class="dropdown">
                                <button class="dropbtn">Stall Owners</button>
                                    <div class="dropdown-content">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="img/foodlehlogo.png" alt="FoodLeh Logo" />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0"><!--insert heading here--></h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Hungry? Just order now!</p>
            </div>
        </header>
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto"><p class="lead">Freelancer is a free bootstrap theme created by FoodLeh. The download includes the complete source files including HTML, CSS, and JavaScript as well as optional SASS stylesheets for easy customization.</p></div>
